<template>
    ...
    <header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar">
        ...
        <button @click="toggleMenuBtn" class="btn btn-link bd-search-docs-toggle d-md-none p-0 ml-3 collapsed" type="button"
        ...
        <div class="navbar-nav-scroll">
            <ul class="navbar-nav bd-navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/one">Two</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/one">Three</a>
                </li>
            </ul>
        </div>
        ...
        <ul class="navbar-nav ml-md-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-md-right" aria-labelledby="bd-versions">
                    ...
                    <a class="dropdown-item" href="/">Five</a>
                    <div class="dropdown-divider"></div>
        ...
        <a class="btn btn-bd-download d-none d-lg-inline-block mb-3 mb-md-0 ml-md-3" href="#">Cool btn</a>
    </header>
  <div class="container-fluid">
    <div class="row flex-xl-nowrap">

            <div class="col-md-3 col-xl-2 sidebar" :class="openedMenu ? 'opened-sidebar' : 'closed-sidebar'">
